...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ih /ems/elsc-labs/segev-i/moria.fridman/project/data_analysis_git/data_analysis/allen_model_analysis/allen_model/ID486262299/modfiles/Ih.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ems/elsc-labs/segev-i/moria.fridman/project/data_analysis_git/data_analysis/allen_model_analysis/allen_model/ID486262299/modfiles/Ih.mod";
static const char* nmodl_file_text = 
