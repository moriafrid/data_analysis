...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kv2like /ems/elsc-labs/segev-i/moria.fridman/project/data_analysis_git/data_analysis/allen_model_analysis/neuronal_model/modfiles/Kv2like.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ems/elsc-labs/segev-i/moria.fridman/project/data_analysis_git/data_analysis/allen_model_analysis/neuronal_model/modfiles/Kv2like.mod";
static const char* nmodl_file_text = 
  ": Kv2-like channel\n"
