...
# allen_model=glob('../neuromorpho_data/allen_model/*.swc')
# one_cell=['../neuromorpho_data/allen_model/Oxtr-T2A-Cre_Ai14-314784.06.01.01_656643532_m.swc']
...
# except FileExistsError: pass
for file in rat_previous+rat_svoboda    :
    ...
    if file!='../neuromorpho_data/svoboda/CNG version/gR004P1.CNG.swc':
        for sec in h.axon:
