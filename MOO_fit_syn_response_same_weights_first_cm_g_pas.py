...
def run(cell, seed=0):
    ...
    parameters_list.append(
        ephys.parameters.NrnSectionParameter(name="Ra", param_name="Ra", value=passive_val[cell_name]["RA"],
                                             bounds=[100, 300], locations=sec_list, frozen=RA_FROZEN))
    parameters_list.append(
        ephys.parameters.NrnSectionParameter(name="g_pas", param_name="g_pas", value=1.0 / passive_val[cell_name]["RM"],
    ...
    #for i, syn in enumerate(synapses_locations[cell_name]):
    ...
    syn_params.append(ephys.parameters.NrnPointProcessParameter(
        name='exp2syn_tau2',
        param_name='tau2',
        value=1.8,  # min(AMPA_FIT[cell_name]['tau2'],8),
    ...
    pickle.dump({
        ...
        "hist": hist,
        "logs": logs,
        "tau": peel_epsp_first[cell_name] / 1000.0,
        "Rin": Rin[cell_name],
        "model": model.__str__()
    ...
    temp = temp[start:]
    temp2 = temp2[start:]
    plt.plot(temp, temp2, color=color_map2[cell_name], alpha=0.6, linewidth=5)
...
CM_startValue = passive_val[cell_name]["CM"] #cell is the name of the cell
R_neck=100
