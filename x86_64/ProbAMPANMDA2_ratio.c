...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 7;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA2_RATIO /ems/elsc-labs/segev-i/moria.fridman/project/data_analysis_git/data_analysis/mechanisms/ProbAMPANMDA2_ratio.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ems/elsc-labs/segev-i/moria.fridman/project/data_analysis_git/data_analysis/mechanisms/ProbAMPANMDA2_ratio.mod";
static const char* nmodl_file_text = 
