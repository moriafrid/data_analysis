...
def change_syn_params(tau_r, tau_d, g_max):
    pass
...
def efun(vals):
    ...
    if (CM < 0.3 or RM < 2000 or RA <RA_const):
        return 1e6
...
opt_vals.x[RA_IX] = RA
opt_vals.x[CM_IX] = CM
change_model_pas(CM=CM, RA=RA_const, RM=RM, E_PAS=E_PAS)
...
plot_res(CM=CM_const, RM=RM, RA=RA, save_name="before")
