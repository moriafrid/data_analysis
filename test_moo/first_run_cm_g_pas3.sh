...
export PATH="/ems/elsc-labs/segev-i/moria.fridman/anaconda2/bin:$PATH"  ## <<-- Change this to the path that you use
export PATH="/ems/elsc-labs/segev-i/moria.fridman/neuron/nrn/x86_64/bin:$PATH"
export PATH="/ems/elsc-labs/segev-i/moria.fridman/neuron/nrn/lib/python:$PATH"
export PYTHONDIR="/ems/elsc-labs/segev-i/moria.fridman/anaconda2/bin/"
