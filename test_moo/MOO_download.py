...
matplotlib.use('agg')
runnum='78' #change for every running
...
def run(cell, seed=0):
    ...
    #############################################################################################################
    # RDSM_objective_file = "/ems/elsc-labs/segev-i/moria.fridman/project/data_analysis_git/data_analysis/data/correct_syn2/mean_syn.p"
    # RDSM_objective_file = "/ems/elsc-labs/segev-i/moria.fridman/project/data_analysis_git/data_analysis/data/syn/mean_syn_short.p"
