...
shrinkage_by=1#round(1.0/0.7,4)
resize_diam_by=1
in_parallel=False
...
dict_1=read_from_pickle('../data/fit/'+spine_type+'/'+name2run+'/different_initial_conditions/RA0_100:300:2_RA0_50:100:0.5/RA0_10_minimums.p')
